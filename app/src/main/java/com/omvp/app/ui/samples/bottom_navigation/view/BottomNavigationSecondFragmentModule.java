...
public abstract class BottomNavigationSecondFragmentModule {
    ...
    @Binds
    @PerFragment
    abstract Fragment secondFragment(BottomNavigationSecondFragment fragment);

    @Binds
    @PerFragment
    abstract BottomNavigationView secondView(BottomNavigationSecondFragment fragment);
}
