...
public class SampleInputActivity extends BaseFragmentActivity implements
        SampleInputFragment.FragmentCallback,
        ToolbarInterceptorCallback,
        InjectFragmentInterceptorCallback<SampleInputFragment> {
    ...
    private SampleInputFragment mFragment;
    ...
    @Override
    public SampleInputFragment onCreateFragment() {
        return SampleInputFragment.newInstance(mExtras);
    }

    @Override
    public void onFragmentLoaded(SampleInputFragment fragment) {
        mFragment = fragment;
    }
